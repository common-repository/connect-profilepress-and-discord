...
= Important Links =
* [Github →](https://github.com/expresstechsoftware/Connect-ProfilePress-and-Discord)

== Installation ==

= Download, Install and Activate! =
1. Go to Plugins > Add New to find and install Connect ProfilePress and Discord.
...
== Screenshots ==
1. Install and activate the plugin and view the "Discord Settings" menu inside ProfilePress.
2. Map Discord roles and Membership plans.
3. Advanced settings.
